...
def create_bag_of_words(patterns):
...
def preprocess_train_data(ignore_words):
    ...
    train_x = bag_of_words_encoding(stem_words, word_tags_list, ignore_words)
    train_y = class_label_encoding(tag_classes, word_tags_list, ignore_words)
    
    return train_x, train_y

bow_data  , label_data = preprocess_train_data(ignore_words)
